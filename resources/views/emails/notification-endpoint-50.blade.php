            ...
            <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 0;padding-bottom: 64px;">
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">The Sim {{$endpoint->iccid}} has used 50% of its current usage.</h2>
                        <p style="margin-top: 0px;margin-bottom: 0px;">Please login/register on <a href="https://mobile.eagle.brd.ltd/">Love Mobile Data</a> to view your usage! </p>
                    </td>
                </tr>
                </tbody>
            </table>
