				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<a href="#" class="text-center pt-2">
							<img src="/media/mobile-data-top-up-logo-stacked.png" class="max-h-75px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
							...
							<div class="login-form login-signup pt-11">
								...
								<form class="form" novalidate="novalidate" id="kt_login_signup_form" method="POST" action="{{ route('register') }}">
									...
									<div class="form-group">
										...
										<input type="checkbox" name="agree" /> I Agree to the love mobile data <a target="_blank" href="https://lovemobiledata.com/terms-and-conditions/">terms and conditions</a>.
										<span></span></label>
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
									<div class="form-group d-flex flex-wrap flex-center pb-lg-0 pb-3">
										<button type="submit" id="" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Submit</button>
